...
class ClientCreateReport extends Component {
    constructor(props){
        super(props)
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select onChange={this.reportType}
                                        ...
                                        value={this.state.report_type}>
                                            ...
                                            <MenuItem value='Safegaurd'>Others</MenuItem>
                                            <MenuItem value='Medication'>Schedule Cancellation</MenuItem>
                                    </Select>
                                </FormControl>
                                <FormControl className={classes.formControl}>
...
export default withStyles(styles)(ClientCreateReport)